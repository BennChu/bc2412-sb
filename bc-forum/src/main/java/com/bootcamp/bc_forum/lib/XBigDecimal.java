...
public class XBigDecimal {
    ...
    // private constructor, not allow ppl to call
    // if call, please the static method below
    ...
    public static void main(String[] args) {
        ...
        System.out.println(XBigDecimal.valueOf(10.0).setRoundingMode(RoundingMode.CEILING).divide(3.0).doubleValue());
    }
}
